...
**/
public class World implements Design {
  ...
  private ArrayList<Predator> _Predators;
  ...
  **/
  ...
  /**
  Place the obstacles according to the Principle and build the walkable matrix.
  ...
  **/  
  public void positionObstacles(ArrayList<Obstacle> obstacles) {
    ...
    for (Obstacle obstacle : obstacles) {
      // get a position from the Principle
      CoordinateInt position = _Principle.generateObstaclePosition();
  ...
  **/
    ...
    for (int y = 0; y < _gridSize.getY(); y++) {
      for (int x = 0; x < _gridSize.getX(); x++) {
        ...
        if (x < _gridSize.getX() - 1) {
          // upper right
          if (y > 0) {
            // make sure the Predator won't get stuck, so diagonal edges may not have adjacent obstacles
  ...
  /**
  Tell the world about the Rabbit.
  **/
  ...
  /**
  Tell the world about a Predator.
  **/
  public void registerPredators(ArrayList<Predator> Predators) {
    _Predators = Predators;
  }
  
  /**
  Tell the world about the Principle.
  **/
  public void registerPrinciple(Principle Principle) {
