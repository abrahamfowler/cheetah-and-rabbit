...
Controls: Click where you want to go. p or P pauses the game.
 ...
 The goal is to reach the green square, while avoiding the hunting cheetahs . There are some obstacles, indicating squares that cannot be visited.
The hunting plredators have different strategies. The first one follows you around. It goes where you go. The second one is an Cheetah2 that always tries to go between you and the goal. The third one tries to cut off posible escape routes. Its position depends on that of the other Predators. Together they form a coordinated team.
...
final double Cheetah_SPEED = 1.2;
final double Cheetah2_SPEED = 1.1;
final double Cheetah3_SPEED = 1.0;
...
final String Predator_Cheetah2_IMAGE = "Predator_Cheetah2.png";
final String Predator_Cheetah3_IMAGE = "Predator_Cheetah3.png";
...
void load() {
  ...
  // Cheetah2
  PImage Cheetah2Image = loadImage(Predator_Cheetah2_IMAGE);
  Cheetah2 Cheetah2 = new Cheetah2(Principle.generatePredatorStart(Rabbit), Cheetah2_SPEED, Cheetah2Image, world);
  Predators.add(Cheetah2);
  // square
  PImage Cheetah3Image = loadImage(Predator_Cheetah3_IMAGE);
  Cheetah3 Cheetah3 = new Cheetah3(Principle.generatePredatorStart(Rabbit), Cheetah3_SPEED, Cheetah3Image, world);
  Predators.add(Cheetah3);
  // tell world
