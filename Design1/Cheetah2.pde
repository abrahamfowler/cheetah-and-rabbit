/**
Cheetah2 type Predator. It goes to a point halfway between the Rabbit and the goal.
**/
public class Cheetah2 extends Predator {
  
  /**
  Constructor
  **/
  public Cheetah2(CoordinateInt position, Double speed, PImage image, World world) {
